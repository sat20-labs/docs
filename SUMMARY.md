...
* 开始：选择你的路径
  ...
  * [我运行基础设施](start-here/infrastructure.md)
...
* 使用聪网
  ...
  * [Prediction 合约测试](use/prediction-contract.md)
  * [完成第一次 Swap](use/first-swap.md)
  * [提供 AMM 流动性](use/amm-liquidity.md)
  * [使用限价单](use/limit-order.md)
  * [参与 Launchpad](use/launchpad.md)
  * [注册 DAO UID](use/dao-uid.md)
  * [向社区基金捐献](use/community-fund-donation.md)
  * [申请与审核空投](use/airdrop.md)
  * [加入社区 DEX](use/community-dex.md)
  * [使用 Explorer 验证交易](use/explorer-verification.md)
...
* 开发者中心
  ...
  * [EVM 样本合约](build/evm-sample-contracts.md)
  * [Prediction 合约 Quickstart](build/prediction-contract-quickstart.md)
  * [搭建社区 DEX / DAO](build/community-dex-quickstart.md)
  * [部署社区 DAO](build/dao-quickstart.md)
  * [部署智能合约模板 AMM 池](build/amm-pool-quickstart.md)
  * [部署 Launchpad](build/launchpad-quickstart.md)
  * [部署智能合约模板限价单模块](build/limit-order-quickstart.md)
  * [运行核心节点、Indexer 和 Explorer](build/infrastructure-quickstart.md)
  * [集成 Wallet SDK](build/wallet-sdk-quickstart.md)
  * [搭建白标 DEX](build/white-label-dex.md)
  * [构建 SatoshiNet AI Agent](build/ai-agent-quickstart.md)
  * [合约模板目录](build/contract-template-catalog.md)
