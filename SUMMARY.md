...
* 资产流通协议 STP
  ...
  * [STP 技术白皮书](circulation/stp/readme.md)
  * [第三方 STP 客户端接入指南](circulation/stp/client-integration.md)
  * [STP 第三方客户端实现验收清单](circulation/stp/implementation-checklist.md)
  * [STP Agent 资产安全控制指南](circulation/stp/asset-safety.md)
  * [STP Agent 互操作技能规范](circulation/stp/agent-skills.md)
  * [Agent 可控钱包与 STP Skills 规划](circulation/stp/agent-wallet-roadmap.md)
  * [Agent Skill 安装与使用](circulation/stp/skill.md)
  * [STP Skill 测试网验证记录](circulation/stp/testnet-skill-validation.md)
  * [STP 测试网 1 分钟演示脚本](circulation/stp/testnet-demo-storyboard.md)
  * [STP 测试网惩罚演练短视频制作规范](circulation/stp/testnet-punish-drill-video.md)
