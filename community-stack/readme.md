...
7. 上线社区 DEX / DAO。
8. 进入 [Built on SatoshiNet](../ecosystem/built-on-satoshinet.md) 展示页。
...
- 查看 [SatoshiNet Today：当前可用能力](../ecosystem/satoshinet-today.md)。
- 阅读 [Builder Program](../ecosystem/builder-program.md)。
- 准备社区需求说明。
- 申请成为首批社区合作伙伴。
