...
12. Watch BTC L1 for the old Core Node-side commitment tx.
...
18. If the user asks for a shareable proof, collect PWA screenshots, L1 explorer pages, L2 explorer pages, indexer JSON, and skill outputs, then follow `docs/ai/sat20-agent-wallet/testnet-punish-drill-video.md` to produce a 2-minute video.
