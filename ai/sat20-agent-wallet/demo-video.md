...
视频使用真实的 BTC testnet4 与 SatoshiNet testnet 演练素材，核心展示的是：

1. 用户通过钱包控制助记词和签名授权。
2. STP 通道把资产放入可验证的 2-of-2 安全边界。
3. 解锁推进提交高度后，旧承诺状态会变成可惩罚状态。
4. 当旧承诺被广播到 BTC L1 后，用户钱包可以广播惩罚交易，把资产扫回自己控制。
...
1. 该视频是测试网演练，不是主网演示。
2. 对外只提供有声成片。
3. 静音底片和制作中间产物仅用于内部制作与复核，不作为公开交付。
